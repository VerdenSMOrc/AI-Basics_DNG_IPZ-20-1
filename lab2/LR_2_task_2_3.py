...
y_test_pred_sigmoid = classifier_sigmoid.predict(X_test)
accuracy_sigmoid = accuracy_score(y_test, y_test_pred_sigmoid)
recall_sigmoid = recall_score(y_test, y_test_pred_sigmoid, average='weighted')
precision_sigmoid = precision_score(y_test, y_test_pred_sigmoid, average='weighted')

# Виведення показників якості
print("Сигмоїдальне ядро:")
print(f"Акуратність: {accuracy_sigmoid:.2f}")
print(f"Повнота: {recall_sigmoid:.2f}")
print(f"Точність: {precision_sigmoid:.2f}")